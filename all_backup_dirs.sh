...
./backup_dirs.sh -p shawn_home_backup_ -l ${local_dir} -n ${network_dir} /home/shawn/.profile /home/shawn/.vim/ /home/shawn/.vimrc
./backup_dirs.sh -p html_css_backup_ -l ${local_dir} -n ${network_dir} /share/html_css/
